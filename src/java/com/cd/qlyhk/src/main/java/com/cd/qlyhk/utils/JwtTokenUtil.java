...
public class JwtTokenUtil {
    ...
    public static Claims parseJWT(String jsonWebToken, String base64Security) throws Exception {
        try {
            ...
            throw new Exception("Token过期:" + eje.getMessage());
        } catch (Exception e){
            log.error("===== token解析异常 =====", e);
            throw new Exception("token解析异常:" + e.getMessage());
        }
    }
     ...
     * @throws Exception 
     */
    public static String createJWT(JSONObject param, Audience audience) throws Exception {
        try {
            // 使用HS256加密算法
            ...
            //userId是重要信息，进行加密下
//            String encryId = Base64Util.encode(unionid.getBytes());
            String paramStr = param.toString();

            //添加构成JWT的参数
            JwtBuilder builder = Jwts.builder().setHeaderParam("typ", "JWT")
                    // 可以将基本不重要的对象信息放到claims
                    .setSubject(paramStr)           // 代表这个JWT的主体，即它的所有人
    ...
    public static String getUserId(String token, String base64Security)throws Exception {
        ...
        return new String(Base64Util.decode(userId));
    }
